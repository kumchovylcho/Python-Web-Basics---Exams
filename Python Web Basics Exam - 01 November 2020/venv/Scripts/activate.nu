...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Tamer\PycharmProjects\pythonProject\MyRecipes\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Tamer\PycharmProjects\pythonProject\MyRecipes\venv\Scripts\deactivate.nu'
